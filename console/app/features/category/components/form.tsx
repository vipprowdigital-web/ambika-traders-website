  ...
  useEffect(() => {
    if (categoryData?.data) {
      ...
      setValues({
        ...
        parentCategory: c.parentCategory?._id?.toString() ?? "none",
        seo: {
            ...
            <Card>
              ...
              <CardContent className="space-y-5">
                ...
                <div>
                  ...
                  <Select
                    key={`${values.parentCategory}-${allCategories?.data?.length || 0}`} // 👈 FORCE UPDATE
                    value={values.parentCategory || "none"}
                    onValueChange={(v) =>
                      handleChange("parentCategory", v === "none" ? "" : v)
                    }
                  >
                    <SelectTrigger>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {/* ICON */}
                <div>
                  <Label className="mb-2">Category Icon</Label>
                  <div
