...
const PRODUCTS: Product[] = [
  {
    ...
    description: "Stainless Steel / 128mm",
    category: { name: "Cabinet Hardware", slug: "cabinet-hardware" },
    images: [{ url: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80", publicId: "" }],
  },
  {
    _id: "2",
    name: "Heavy Duty Door Hinges",
    slug: "door-hinges",
    description: "Brass / 4 inch",
    category: { name: "Door Fittings", slug: "door-fittings" },
    images: [{ url: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&q=80", publicId: "" }],
  },
  {
    _id: "3",
    name: "Soft Close Drawer Slides",
    slug: "drawer-slides",
    description: "Full Extension / 450mm",
    category: { name: "Drawer Systems", slug: "drawer-systems" },
    images: [{ url: "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=400&q=80", publicId: "" }],
  },
  {
    _id: "4",
    name: "Mortise Door Lock",
    slug: "mortise-door-lock",
    description: "Zinc Alloy / Satin Finish",
    category: { name: "Security", slug: "security" },
    images: [{ url: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80&sat=-100", publicId: "" }],
  },
  {
    _id: "5",
    name: "Tower Bolt",
    slug: "tower-bolt",
    description: "SS 304 / 8 inch",
    category: { name: "Bolts & Latches", slug: "bolts-latches" },
    images: [{ url: "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=400&q=80", publicId: "" }],
  },
  {
    _id: "6",
    name: "Glass Door Patch Fitting",
    slug: "glass-patch-fitting",
    description: "Chrome Finish / 10-12mm",
    category: { name: "Glass Fittings", slug: "glass-fittings" },
    images: [{ url: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&q=80", publicId: "" }],
  },
];
...
function InquiryButton({ productName }: InquiryButtonProps): React.ReactElement {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="block w-full text-center py-2.5 px-4 rounded-xl bg-gray-100 text-gray-700 text-sm font-semibold hover:bg-gray-200 transition-colors duration-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
    >
      Send Inquiry
    </a>
  );
...
export default function FeaturedProducts(): React.ReactElement {
  ...
  function handleCardClick(slug: string): void {
    router.push("/products?highlight=" + slug);
  }
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-5">
          {PRODUCTS.map(function(product: Product) {
            return (
              <div
                key={product._id}
                onClick={function() { handleCardClick(product.slug); }}
